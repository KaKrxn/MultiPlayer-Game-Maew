...
namespace FileGame.Core
{
    ...
    public static class GameConstants
    {
        ...
        // ── Food Consumption ──────────────────────────────────────
        public const float RottenFoodChance       = 0.15f;  // 15% chance food is rotten
        ...
        public const float VitalityDeadZone  = 0.1f;   // minimum vitality when weight alone can't kill
